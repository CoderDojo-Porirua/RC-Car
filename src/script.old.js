document.addEventListener('DOMContentLoaded', () => {
	...
	const app = new Vue({
		...
		computed: {
			...
			speed: function() {
				return (this.gamepad ? parseFloat((this.gamepad.buttons[7].value - this.gamepad.buttons[6].value.toFixed(2))) : 0);
			},
			turn: function() {
				return (this.gamepad ? parseFloat(this.gamepad.axes[0].toFixed(2)) : 0);
			},
		},
		watch: {
